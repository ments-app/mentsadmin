      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="flex items-center gap-2 rounded-lg border border-card-border px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-card-border/30"
          >
            <Users size={15} />
            Registrations
          </Link>
          ...
          {rounds.map((round, i) => (
            <div key={i} className="rounded-lg border border-card-border p-4 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button type="button" onClick={() => removeRound(i)} className="text-muted hover:text-danger transition-colors">
                  <X size={15} />
                </button>
              </div>
          ...
          {faqs.map((faq, i) => (
            <div key={i} className="rounded-lg border border-card-border p-4 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button type="button" onClick={() => removeFaq(i)} className="text-muted hover:text-danger transition-colors">
                  <X size={15} />
                </button>
              </div>
