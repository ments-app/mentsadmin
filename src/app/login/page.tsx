...
function LoginContent() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm rounded-xl border border-card-border bg-card-bg p-8 shadow-lg">
        ...
        <button
          ...
          disabled={loading}
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-card-border bg-background px-4 py-3 font-medium text-foreground transition-colors hover:bg-card-bg disabled:opacity-50"
        >
          {loading ? (
