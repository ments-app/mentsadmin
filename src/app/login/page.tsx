...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (err === 'unauthorized_domain') {
      setError('Only @ments.app email addresses are allowed.');
    ...
    <div className="flex min-h-screen items-center justify-center bg-background">
      <div className="w-full max-w-md rounded-xl border border-card-border bg-card-bg p-8 shadow-lg">
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-foreground">Ments Admin</h1>
          <p className="mt-2 text-sm text-muted">
            {isRegister ? 'Create an admin account' : 'Sign in to manage your hub'}
          </p>
        </div>
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-card-border bg-background px-4 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-card-border/30 disabled:opacity-50"
        >
