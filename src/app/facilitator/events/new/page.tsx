...
export default function FacilitatorNewEventPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try { await createFacilitatorEvent(form); router.push('/facilitator/events'); }
  ...
  return (
    <div className="mx-auto max-w-2xl animate-fade-in">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-muted">Create an event for your hub</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-3 pt-2">
          <button type="submit" disabled={loading} className="btn-primary py-2.5 px-6">{loading ? 'Creating...' : 'Create Event'}</button>
