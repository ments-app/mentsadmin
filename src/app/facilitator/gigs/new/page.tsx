...
import { createFacilitatorGig } from '@/actions/facilitators';
...
export default function FacilitatorNewGigPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      await createFacilitatorGig(form);
  ...
  return (
    <div className="mx-auto max-w-2xl animate-fade-in">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-muted">Post a freelance or contract gig</p>
      </div>
        ...
        <div className="card-elevated p-5 space-y-4">
          ...
          {form.visibility === 'email_restricted' && (
            <div className="rounded-xl border border-blue-200 bg-blue-50 px-4 py-2.5 text-sm text-blue-700 dark:border-blue-800 dark:bg-blue-950 dark:text-blue-300">
              ...
              <Link href="/facilitator/students" className="font-medium underline">Manage Access List →</Link>
            </div>
          )}
        </div>
